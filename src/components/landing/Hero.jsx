            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                <div className="text-center max-w-4xl mx-auto">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-blue-950 leading-tight mb-6">
                        Fast. Simple. Powerful Invoicing.                </h1>
                    <p className="text-base sm:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
                        Quick Invoice Generator helps freelancers and businesses create professional invoices in just a few clicks. Save time, stay organized, and get paid faster.                    </p>
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="#features" className="border-2 border-black text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-black transition-all duration-200 hover:scale-105">
                            Learn More
                        </a>
                    </div>
                </div>
                <div className="mt-12 relative max-w-5xl mx-auto">
                    <img src={HERO_IMG} alt="Invoice App Screen" className="rounded-2xl shadow-2xl shado-gray-300 border-4 border-gray-200/20" />
                </div>
            </div>
        </section>
    )
